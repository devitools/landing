...
return [
    ...
    'details' => [
        ...
        'diversas etapas da produção de software. Por ser um conjunto de ferramentas, nossas tecnologias ' .
    ...
    'features' => [
        'above-heading' => 'RECURSOS',
        'h2-heading' => 'Conheça mais sobre a Devitools',
        'p-heading' => 'Leve seu fluxo de desenvolvimento de software para outro nível e deixe que a gente resolva ' .
        'os problemas primários da produção. Foque nas regras de negócios, eventos e fluxos de informação que o ' .
        'resto resolvemos para você',
        'nav-link_1' => 'Frontend',
        'nav-link_2' => 'Backend',
        'nav-link_3' => 'Deployment',
    ],
    'newsletter' => [
